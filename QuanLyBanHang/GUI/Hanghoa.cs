...
namespace QuanLyBanHang.GUI
{
    ...
    {
        DataTable tblH;
        Function Classmate = new Function();// khởi tạo
        ...
        public Hanghoa()
        {
            ...
            bllncc = new BLL.BLL_nhacungcap(this);// khởi tạo lớp
        ...
        private void txt_dongianhap_TextChanged_1(object sender, EventArgs e)
        {
            if (txt_dongianhap.Text != "")
            {
                try
                {
                    long r = long.Parse(txt_dongianhap.Text);
                    long kq = r + r * 2 / 10;
                    txt_dongiaban.Text = kq.ToString();
                }
                catch 
                {
                    txt_dongiaban.Text = "";
