...
namespace QuanLyBanHang.DAL
{
    class DAL_hoadon
    {
        ...
        public int ThemHD(string mahd, string manv, DateTime ngayban, string makh, string mah, string soluong, string dongia, string thanhtien)
        {
            ...
            string sql = "Insert into HOADON values(N'" + mahd + "',N'" + manv + "',N'" + ngayban.ToString("yyyy'-'MM'-'dd HH':'mm':'ss.fff") + "',N'" + makh + "',N'" + mah + "',N'" + soluong + "',N'" + dongia + "',N'" + thanhtien + "')";
        ...
        {
            string sql = "Update HOADON set MaNV =N'" + manv + "',NgayBAN = N'" + ngayban.ToString("yyyy'-'MM'-'dd HH':'mm':'ss.fff") + "',MaKH = N'" + makh + "',MaH = N'" + mah + "',SoLUONG = N'" + soluong + "',DonGIA = N'" + dongia + "',ThanhTIEN = N'" + thanhtien + "' where MaHD = N'" + mahd + "'";
            return lopchung.AddDel(sql);
        }
